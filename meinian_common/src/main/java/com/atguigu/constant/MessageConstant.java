...
public class MessageConstant {
    ...
    public static final String QUERY_TRAVELITEMBYTRAVELGROUP_SUCCESS ="根据跟团游查询自由行成功";
    public static final String QUERY_TRAVELITEMBYTRAVELGROUP_FAIL ="根据跟团游查询自由行失败";
}